        ...
        <div class="col-md-12">
            ...
            <form action="<?php echo ROOT_URL . '/api/statuts/delete.php' ?>" method="post">
                <div class="form-group">
                    ...
                    <br>
                    <p style="color: red;" class="message-erreur">Remarque : Suppression impossible, il existe des membres associés à ce statut</p>
                </div>
                <br />
                <div class="form-group mt-2">
                    <a href="list.php" class="btn btn-primary">List</a>
                    <button type="submit" class="btn btn-danger disabled">Confirmer la Suppression ? </button>
                </div>
            </form>
        </div>
    </div>
