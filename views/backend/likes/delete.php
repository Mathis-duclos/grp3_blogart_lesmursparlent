...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <form action="<?php echo htmlspecialchars(ROOT_URL . '/api/likes/delete.php?numArt=' . $numArt); ?>" method="post" enctype="multipart/form-data">
                <div>
                    <label for="numArt">Membre ayant liké</label>
                    <input type="text" class="form-control" id="numArt" name="numArt" value="<?php echo htmlspecialchars($numMemb); ?>" disabled>
                </div>
                <div class="form-group">
                    <label for="libTitrArt">Nom de l'article liké</label>
                    <input type="text" class="form-control" id="libTitrArt" name="libTitrArt" value="<?php echo htmlspecialchars($plTitre); ?>" disabled>
                </div>
                <div class="form-group">
                    <label for="likeStatus">Article liké ou non</label>
                    <input type="text" class="form-control" id="likeStatus" name="likeStatus" value="<?php echo htmlspecialchars($likeStatus); ?>" disabled>
                </div>
